(function() {
  ...
  fabric.ITextRtl = fabric.util.createClass(fabric.Text, fabric.Observable, /** @lends fabric.IText.prototype */ {
    ...
    _renderTextLine: function(method, ctx, line, left, top, lineIndex) {
      console.log('itextRtl class _renderTextLine -- inner');
      // this._renderCharsrtl(method, ctx, line, left, top, lineIndex);
      chars = line.toString();
  ...
  fabric.ITextRtl.fromObject = function(object, callback) {
    ...
    fabric.Object._fromObject('ITextRtl', object, callback, 'text');
  };
})();
